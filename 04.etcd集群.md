...
``` bash
cd /opt/k8s/work
wget https://github.com/coreos/etcd/releases/download/v3.4.3/etcd-v3.4.3-linux-ppc64le.tar.gz
tar -xvf etcd-v3.4.3-linux-ppc64le.tar.gz
```
...
for node_ip in ${NODE_IPS[@]}
  do
    echo ">>> ${node_ip}"
    scp etcd-v3.4.3-linux-ppc64le/etcd* root@${node_ip}:/opt/k8s/bin
