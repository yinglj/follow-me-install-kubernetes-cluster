...
+ power-k8s-01：10.10.13.163
+ power-k8s-02：10.10.13.170
+ power-k8s-03：10.10.13.180

注意：
1. 如果没有特殊指明，本文档的所有操作**均在 power-k8s-01 节点上执行**；
...
``` bash
cd /opt/k8s/work
wget -c https://github.com/coreos/etcd/releases/download/v3.4.7/etcd-v3.4.7-linux-ppc64le.tar.gz
tar -xvf etcd-v3.4.7-linux-ppc64le.tar.gz
```
...
for node_ip in ${NODE_IPS[@]}
  do
    echo ">>> ${node_ip}"
    scp etcd-v3.4.7-linux-ppc64le/etcd* root@${node_ip}:/opt/k8s/bin
...
``` bash
>>> 10.10.13.163
https://10.10.13.163:2379 is healthy: successfully committed proposal: took = 2.756451ms
>>> 10.10.13.170
https://10.10.13.170:2379 is healthy: successfully committed proposal: took = 2.025018ms
>>> 10.10.13.180
https://10.10.13.180:2379 is healthy: successfully committed proposal: took = 2.335097ms
```
...
+-----------------------------+------------------+---------+---------+-----------+------------+-----------+------------+--------------------+--------+
| https://10.10.13.163:2379 | 4250b255e93e0076 |   3.4.3 |   20 kB |     false |      false |         2 |          8 |                  8 |        |
| https://10.10.13.170:2379 | b3d912e6166f1213 |   3.4.3 |   20 kB |      true |      false |         2 |          8 |                  8 |        |
| https://10.10.13.180:2379 | 8a4d4a2904de8446 |   3.4.3 |   20 kB |     false |      false |         2 |          8 |                  8 |        |
+-----------------------------+------------------+---------+---------+-----------+------------+-----------+------------+--------------------+--------+
```
