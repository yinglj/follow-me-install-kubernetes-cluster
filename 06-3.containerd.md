...
``` bash
cd /opt/k8s/work
wget https://github.com/kubernetes-sigs/cri-tools/releases/download/v1.17.0/crictl-v1.17.0-linux-ppc64le.tar.gz \
  https://github.com/opencontainers/runc/releases/download/v1.0.0-rc10/runc.ppc64le \
  https://github.com/containernetworking/plugins/releases/download/v0.8.5/cni-plugins-linux-ppc64le-v0.8.5.tgz \
  https://github.com/containerd/containerd/releases/download/v1.3.3/containerd-1.3.3.linux-ppc64le.tar.gz 
```
