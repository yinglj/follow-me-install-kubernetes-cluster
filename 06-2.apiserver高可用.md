...
stream {
    upstream backend {
        ...
        server 10.10.13.163:6443        max_fails=3 fail_timeout=30s;
        server 10.10.13.170:6443        max_fails=3 fail_timeout=30s;
        server 10.10.13.180:6443        max_fails=3 fail_timeout=30s;
    }
